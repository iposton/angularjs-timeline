            ...
            template: `<div class="container player-list" layout="row" flex>
                        ...
                        <md-content id="content">
                            ...
                            <div style="margin-top:100px; text-align: center;">
                                Select a player in the side navigation and then use the input box to add Minutes played. The Max value is 12 minutes. This Timeline represents one quarter of professional basketaball with a timeline displaying 12 minutes in seconds.
                            </div>
                        </md-content>
                       </div>`
